module.exports = {
  ...
  seoTitleSuffix: "David Ruiz", // SEO title syntax will be e.g. "Imprint - {seoTitleSuffix}"
  ...
  navLinks: {
    ...
    button: {
      useFileName: true,
      name: "Resume",
      fileName: "curriculum.pdf", // the file has to be placed inside the static folder at the root level
